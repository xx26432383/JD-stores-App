  ...
  <div>
    <el-container>
      ...
      <el-footer v-show="meta.footerShow">
        ...
        <div @click="$router.push({path: '/driver-info'})" v-show="userType === 'shop'">
          <!-- <img v-show="currentPath !== '/comm-home'" src="../assets/home2.png" alt=""> -->
        ...
        <!-- 司机 -->
        <div @click="$router.push({path: '/driver-home'})" v-show="userType === 'driver'">
          <!-- <img v-show="currentPath !== '/comm-home'" src="../assets/home2.png" alt=""> -->
          <img src="../assets/home2.png" alt="">
          <div :style="{color: currentPath === '/driver-home' ? '#C39862' : '#333333'}">门店</div>
        </div>
